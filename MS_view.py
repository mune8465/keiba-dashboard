...
if df_raw is not None:
    ...
    if selected_place:
        ...
        if selected_race_name:
            ...
            # コース種別（芝・ダート）を判定
            is_dirt = "ダート" in str(df_race['コース'].iloc[0]) if 'コース' in df_race.columns else False
            course_label = "ダート" if is_dirt else "芝"
            
            st.subheader(f"📊 MS指数 期待値統計 ({course_label})")

            # 統計データの定義
            ms_stats_shiba = [
                [50.1, 99.9, "32.3%", "67.7%", "83.9%"], [45.1, 50, "33.3%", "63.6%", "69.7%"],
                [40.1, 45, "40.8%", "61.2%", "77.6%"], [35.1, 40, "34.5%", "58.3%", "77.4%"],
                [30.1, 35, "28.0%", "47.8%", "61.8%"], [25.1, 30, "31.6%", "53.6%", "70.7%"],
                [20.1, 25, "23.0%", "40.5%", "53.1%"], [15.1, 20, "17.0%", "31.8%", "45.2%"],
                [10.1, 15, "12.2%", "24.0%", "35.6%"], [5.1, 10, "6.5%", "14.1%", "22.0%"],
                [0.2, 5, "3.1%", "6.7%", "11.1%"], [0.1, 0.1, "1.6%", "4.1%", "6.8%"]
            ]
            
            ms_stats_dirt = [
                [50.1, 99.9, "63.6%", "72.7%", "77.3%"], [45.1, 50, "37.5%", "68.8%", "87.5%"],
                [40.1, 45, "34.9%", "60.5%", "74.4%"], [35.1, 40, "40.2%", "61.0%", "67.1%"],
                [30.1, 35, "36.7%", "54.7%", "65.6%"], [25.1, 30, "25.0%", "43.0%", "58.5%"],
                [20.1, 25, "25.3%", "43.7%", "56.8%"], [15.1, 20, "17.8%", "32.7%", "44.1%"],
                [10.1, 15, "12.3%", "24.9%", "35.3%"], [5.1, 10, "6.4%", "13.5%", "21.6%"],
                [0.2, 5, "2.5%", "6.1%", "10.6%"], [0.1, 0.1, "1.7%", "3.7%", "6.9%"]
            ]

            # 表示するデータを選択
            target_stats = ms_stats_dirt if is_dirt else ms_stats_shiba
            df_stats = pd.DataFrame(target_stats, columns=["min", "max", "勝率", "連対率", "複勝率"])
